(function ($) {
    ...
    function toggleCompanyFields() {
        ...
        if (accountType === 'particular') {
            $('#edit-field-name-company, #edit-field-siret-company, #edit-field-email-company, #edit-field-phone-company').hide();
        } else {
            $('#edit-field-name-company, #edit-field-siret-company, #edit-field-email-company, #edit-field-phone-company').show();
        }
    }
